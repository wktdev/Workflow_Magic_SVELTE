...
async function editWorkflow(){
           ...
           window.location.href = "#/client/"+params.clientId+"/dashboard/workflows/" + workflowId + "/edit";
        ...
        <div class="row">
          ...
          <div class="col-12">
            ...
            <header class="header">
             ...
             <button on:click = {editWorkflow} class="btn btn-info btn-block my-4" >Edit This Workflow</button>
